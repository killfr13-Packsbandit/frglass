...
const copy = {
  en: {
    ...
    alt1: "Borosilicate glass detail from the workshop",
  ...
  de: {
    ...
    alt1: "Borosilikatglas-Detail aus der Werkstatt",
  ...
  return (
    <main className="min-h-screen bg-black px-4 py-24 text-white sm:px-6 sm:py-32">
      <section className="mx-auto max-w-7xl">
        ...
        <h1 className="max-w-4xl break-words text-4xl font-black uppercase leading-tight sm:text-6xl">{t.title1}<br />{t.title2}</h1>
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 sm:gap-8 md:grid-cols-2">
          <div className="relative h-[400px] overflow-hidden rounded-2xl border border-white/10 bg-white/5 sm:h-[560px] sm:rounded-3xl">
            <Image src="/jewelry/Cobald5 x Opaldust Leaf.jpg" alt={t.alt1} fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" />
          </div>
          <div className="relative h-[400px] overflow-hidden rounded-2xl border border-white/10 bg-white/5 sm:h-[560px] sm:rounded-3xl">
            <Image src="/workshop/me2.jpg" alt={t.alt2} fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" />
          </div>
        </div>
        ...
        <div className="mx-auto mt-14 max-w-3xl sm:mt-20">
          <h2 className="text-3xl font-black uppercase sm:text-4xl">{t.sectionTitle}</h2>
          <p className="mt-6 text-base leading-7 text-neutral-300 sm:text-lg sm:leading-8">{t.p1}</p>
