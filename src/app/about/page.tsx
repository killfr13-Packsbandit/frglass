...
const copy = {
  en: {
    eyebrow: "Biography",
    p1: "Hey, my name is Florian Robatsch and I'm from Carinthia, Austria. Since 2019, I have been working intensively with borosilicate glass and discovered my passion for lampworking – a special form of glasswork at the flame.",
  ...
  de: {
    eyebrow: "Biografie",
    p1: "Hey, mein Name ist Florian Robatsch und ich komme aus Kärnten, Österreich. Seit 2019 beschäftige ich mich intensiv mit Borosilikatglas und habe dabei meine Leidenschaft für das Lampworking entdeckt – eine besondere Form der Glasbearbeitung an der Flamme.",
