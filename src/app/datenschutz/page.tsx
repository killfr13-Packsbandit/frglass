...
const copy = {
  de: {
    ...
    hosting: "Hosting",
    hostingText: "Diese Website wird über Cloudflare Workers bereitgestellt. Beim Aufruf der Website können technisch erforderliche Verbindungs- und Serverdaten verarbeitet werden, insbesondere IP-Adresse, Zeitpunkt des Zugriffs, aufgerufene Ressource und technische Browserinformationen. Die Verarbeitung dient dem sicheren und zuverlässigen Betrieb der Website und erfolgt auf Grundlage des berechtigten Interesses gemäß Art. 6 Abs. 1 lit. f DSGVO. Je nach technischer Bereitstellung kann Cloudflare Daten auch außerhalb des EWR verarbeiten; hierfür gelten die von Cloudflare bereitgestellten Datenschutz- und Übermittlungsmechanismen.",
  ...
  en: {
    ...
    hosting: "Hosting",
    hostingText: "This website is delivered through Cloudflare Workers. When the website is accessed, technically necessary connection and server data may be processed, including IP address, time of access, requested resource and technical browser information. This processing is used to operate the website securely and reliably and is based on legitimate interests under Art. 6(1)(f) GDPR. Depending on the technical delivery of the service, Cloudflare may also process data outside the EEA; Cloudflare's applicable data-protection and transfer mechanisms apply in those cases.",
