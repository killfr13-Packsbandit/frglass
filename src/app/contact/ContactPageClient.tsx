...
const copy = {
  en: {
    ...
    title: "Get in touch.",
    intro:
      "Interested in a piece, a custom idea or the future studio setup? Send me a message here. Your inquiry is sent directly to me by email, and I can reply personally.",
    listTitle: "You can ask me about",
    items: [
      "Available pieces",
      "Custom ideas and commissions",
      "Future torch or studio time",
      "Small workshops",
    ],
  },
  de: {
    ...
    title: "Meld dich.",
    intro:
      "Du interessierst dich für ein Stück, eine eigene Idee oder die spätere Werkstatt-Nutzung? Schreib mir hier direkt. Deine Anfrage wird per E-Mail an mich geschickt und ich kann dir persönlich antworten.",
    listTitle: "Du kannst mich fragen wegen",
    items: [
      "Verfügbaren Stücken",
      "Eigener Ideen und Anfragen",
      "Späterer Brenner- oder Werkstattzeit",
      "Kleinen Workshops",
    ],
  },
} as const;
...
export default function ContactPageClient({
  ...
  const items = t.items
    .map((fallback, index) => get(`contact.item${index + 1}.${lang}`, fallback))
    ...
    <main className="min-h-screen bg-black px-4 py-24 text-white sm:px-6 sm:py-32">
      <section className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          <InquiryForm productName={productName} productSlug={productSlug} />
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 sm:p-8">
            ...
            <div className="mt-8 border-t border-white/10 pt-6">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-4 inline-flex rounded-full border border-white/20 px-5 py-3 text-sm font-bold uppercase tracking-widest text-white transition hover:border-orange-300 hover:text-orange-300"
              >
                Instagram
              </a>
            </div>
