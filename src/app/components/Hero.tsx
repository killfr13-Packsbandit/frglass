...
export default function Hero() {
  ...
  const imageStyle = { objectPosition: `${focusX}% ${focusY}%`, transform: `scale(${zoom})`, transformOrigin: `${focusX}% ${focusY}%` };
