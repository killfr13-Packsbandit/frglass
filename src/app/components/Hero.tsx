...
export default function Hero() {
  ...
  const zoom = Number(get("home.hero.media.zoom", "1")) || 1;
  const focusX = Number(get("home.hero.media.focusX", "50")) || 50;
  const focusY = Number(get("home.hero.media.focusY", "50")) || 50;
  const mediaStyle = { objectPosition: `${focusX}% ${focusY}%`, transform: `scale(${zoom})`, transformOrigin: `${focusX}% ${focusY}%` };
